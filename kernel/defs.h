...
// raid.c
void            loadraid(void);
uint            diskblockn(void);
uint            raidblockn(void);
int             readraid(int vblkn, uchar* data);
int             writeraid(int vblkn, uchar* data);
void            writeraidmeta(void);
int             setraidtype(int type);
...
int             raidfail(int diskn);
int             raidrepair(int diskn);
