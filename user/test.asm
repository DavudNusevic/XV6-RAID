...
noise(int i, int j)
{
       ...
       e:	87ba                	mv	a5,a4
      10:	fcf42c23          	sw	a5,-40(s0)
  int n = i + j;
      14:	fdc42783          	lw	a5,-36(s0)
      18:	873e                	mv	a4,a5
      1a:	fd842783          	lw	a5,-40(s0)
  ...
  switch (n%3)
      ...
      28:	873e                	mv	a4,a5
      2a:	478d                	li	a5,3
      2c:	02f767bb          	remw	a5,a4,a5
      30:	2781                	sext.w	a5,a5
      32:	c791                	beqz	a5,3e <noise+0x3e>
      34:	873e                	mv	a4,a5
      36:	4785                	li	a5,1
      38:	00f70f63          	beq	a4,a5,56 <noise+0x56>
      3c:	a80d                	j	6e <noise+0x6e>
  {
    case 0:
      return '&' + (i & 3);
      3e:	fdc42783          	lw	a5,-36(s0)
      42:	0ff7f793          	zext.b	a5,a5
      46:	8b8d                	andi	a5,a5,3
      48:	0ff7f793          	zext.b	a5,a5
      4c:	0267879b          	addiw	a5,a5,38
      50:	0ff7f793          	zext.b	a5,a5
      54:	a805                	j	84 <noise+0x84>
    case 1:
      return 'F' + (j & 3);
      56:	fd842783          	lw	a5,-40(s0)
      5a:	0ff7f793          	zext.b	a5,a5
      5e:	8b8d                	andi	a5,a5,3
      60:	0ff7f793          	zext.b	a5,a5
      64:	0467879b          	addiw	a5,a5,70
      68:	0ff7f793          	zext.b	a5,a5
      6c:	a821                	j	84 <noise+0x84>
    default:
      return '<' + (i & 7);
      6e:	fdc42783          	lw	a5,-36(s0)
      72:	0ff7f793          	zext.b	a5,a5
      76:	8b9d                	andi	a5,a5,7
      78:	0ff7f793          	zext.b	a5,a5
      7c:	03c7879b          	addiw	a5,a5,60
...
main(void)
{
      8c:	7135                	addi	sp,sp,-160
      8e:	ed06                	sd	ra,152(sp)
      90:	e922                	sd	s0,144(sp)
      92:	e526                	sd	s1,136(sp)
      94:	e14a                	sd	s2,128(sp)
      96:	fcce                	sd	s3,120(sp)
      98:	f8d2                	sd	s4,112(sp)
      9a:	f4d6                	sd	s5,104(sp)
      9c:	f0da                	sd	s6,96(sp)
      9e:	ecde                	sd	s7,88(sp)
      a0:	e8e2                	sd	s8,80(sp)
      a2:	e4e6                	sd	s9,72(sp)
      a4:	1100                	addi	s0,sp,160
  printf("Starting..\n");
      a6:	00001517          	auipc	a0,0x1
      aa:	03a50513          	addi	a0,a0,58 # 10e0 <malloc+0x140>
      ae:	00001097          	auipc	ra,0x1
      b2:	d00080e7          	jalr	-768(ra) # dae <printf>

  if (init_raid(RAID1) < 0)
      b6:	4505                	li	a0,1
      b8:	00001097          	auipc	ra,0x1
      bc:	836080e7          	jalr	-1994(ra) # 8ee <init_raid>
      c0:	87aa                	mv	a5,a0
      c2:	0007df63          	bgez	a5,e0 <main+0x54>
  {
    printf("Fatal error on init_raid\n");
      c6:	00001517          	auipc	a0,0x1
      ca:	02a50513          	addi	a0,a0,42 # 10f0 <malloc+0x150>
      ce:	00001097          	auipc	ra,0x1
      d2:	ce0080e7          	jalr	-800(ra) # dae <printf>
    exit(-1);
      d6:	557d                	li	a0,-1
      d8:	00000097          	auipc	ra,0x0
      dc:	776080e7          	jalr	1910(ra) # 84e <exit>
  }

  uint diskn, blkn, blks;
  if (info_raid(&blkn, &blks, &diskn) < 0)
      e0:	f6840693          	addi	a3,s0,-152
      e4:	f6040713          	addi	a4,s0,-160
      e8:	f6440793          	addi	a5,s0,-156
      ec:	8636                	mv	a2,a3
      ee:	85ba                	mv	a1,a4
      f0:	853e                	mv	a0,a5
      f2:	00001097          	auipc	ra,0x1
      f6:	824080e7          	jalr	-2012(ra) # 916 <info_raid>
      fa:	87aa                	mv	a5,a0
      fc:	0007df63          	bgez	a5,11a <main+0x8e>
  {
    printf("Fatal error on info_raid\n");
     100:	00001517          	auipc	a0,0x1
     104:	01050513          	addi	a0,a0,16 # 1110 <malloc+0x170>
     108:	00001097          	auipc	ra,0x1
     10c:	ca6080e7          	jalr	-858(ra) # dae <printf>
    exit(-1);
     110:	557d                	li	a0,-1
     112:	00000097          	auipc	ra,0x0
     116:	73c080e7          	jalr	1852(ra) # 84e <exit>
  }

  printf("blkn=%d, blks=%d, diskn=%d\n", blkn, blks, diskn);
     11a:	f6442783          	lw	a5,-156(s0)
     11e:	f6042703          	lw	a4,-160(s0)
     122:	f6842683          	lw	a3,-152(s0)
     126:	863a                	mv	a2,a4
     128:	85be                	mv	a1,a5
     12a:	00001517          	auipc	a0,0x1
     12e:	00650513          	addi	a0,a0,6 # 1130 <malloc+0x190>
     132:	00001097          	auipc	ra,0x1
     136:	c7c080e7          	jalr	-900(ra) # dae <printf>

  uchar data[blks];
     13a:	f6042783          	lw	a5,-160(s0)
     13e:	02079713          	slli	a4,a5,0x20
     142:	9301                	srli	a4,a4,0x20
     144:	177d                	addi	a4,a4,-1
     146:	f6e43c23          	sd	a4,-136(s0)
     14a:	02079713          	slli	a4,a5,0x20
     14e:	9301                	srli	a4,a4,0x20
     150:	8c3a                	mv	s8,a4
     152:	4c81                	li	s9,0
     154:	03dc5713          	srli	a4,s8,0x3d
     158:	003c9a93          	slli	s5,s9,0x3
     15c:	01576ab3          	or	s5,a4,s5
     160:	003c1a13          	slli	s4,s8,0x3
     164:	02079713          	slli	a4,a5,0x20
     168:	9301                	srli	a4,a4,0x20
     16a:	8b3a                	mv	s6,a4
     16c:	4b81                	li	s7,0
     16e:	03db5713          	srli	a4,s6,0x3d
     172:	003b9993          	slli	s3,s7,0x3
     176:	013769b3          	or	s3,a4,s3
     17a:	003b1913          	slli	s2,s6,0x3
     17e:	1782                	slli	a5,a5,0x20
     180:	9381                	srli	a5,a5,0x20
     182:	07bd                	addi	a5,a5,15
     184:	8391                	srli	a5,a5,0x4
     186:	0792                	slli	a5,a5,0x4
     188:	40f10133          	sub	sp,sp,a5
     18c:	878a                	mv	a5,sp
     18e:	87be                	mv	a5,a5
     190:	f6f43823          	sd	a5,-144(s0)
  int step = 500;
     194:	1f400793          	li	a5,500
     198:	f6f42623          	sw	a5,-148(s0)
  int l = 0, u = step;
     19c:	f8042e23          	sw	zero,-100(s0)
     1a0:	f6c42783          	lw	a5,-148(s0)
     1a4:	f8f42c23          	sw	a5,-104(s0)


  for (int i = 1; i < 10; i++)
     1a8:	4785                	li	a5,1
     1aa:	f8f42a23          	sw	a5,-108(s0)
     1ae:	a089                	j	1f0 <main+0x164>
    if (fork() == 0)
     1b0:	00000097          	auipc	ra,0x0
     1b4:	696080e7          	jalr	1686(ra) # 846 <fork>
     1b8:	87aa                	mv	a5,a0
     1ba:	e795                	bnez	a5,1e6 <main+0x15a>
    {
      l = step * (i + 1);
     1bc:	f9442783          	lw	a5,-108(s0)
     1c0:	2785                	addiw	a5,a5,1
     1c2:	2781                	sext.w	a5,a5
     1c4:	f6c42703          	lw	a4,-148(s0)
     1c8:	02f707bb          	mulw	a5,a4,a5
     1cc:	f8f42e23          	sw	a5,-100(s0)
      u = step * (i + 2);
     1d0:	f9442783          	lw	a5,-108(s0)
     1d4:	2789                	addiw	a5,a5,2
     1d6:	2781                	sext.w	a5,a5
     1d8:	f6c42703          	lw	a4,-148(s0)
     1dc:	02f707bb          	mulw	a5,a4,a5
     1e0:	f8f42c23          	sw	a5,-104(s0)
      break;
     1e4:	a829                	j	1fe <main+0x172>
  for (int i = 1; i < 10; i++)
     1e6:	f9442783          	lw	a5,-108(s0)
     1ea:	2785                	addiw	a5,a5,1
     1ec:	f8f42a23          	sw	a5,-108(s0)
     1f0:	f9442783          	lw	a5,-108(s0)
     1f4:	0007871b          	sext.w	a4,a5
     1f8:	47a5                	li	a5,9
     1fa:	fae7dbe3          	bge	a5,a4,1b0 <main+0x124>
    }

  for (int i = l; i < u; i++)
     1fe:	f9c42783          	lw	a5,-100(s0)
     202:	f8f42823          	sw	a5,-112(s0)
     206:	a041                	j	286 <main+0x1fa>
  {
    for (int j = 0; j < blks; j++)
     208:	f8042623          	sw	zero,-116(s0)
     20c:	a80d                	j	23e <main+0x1b2>
      data[j] = noise(i, j);
     20e:	f8c42703          	lw	a4,-116(s0)
     212:	f9042783          	lw	a5,-112(s0)
     216:	85ba                	mv	a1,a4
     218:	853e                	mv	a0,a5
     21a:	00000097          	auipc	ra,0x0
     21e:	de6080e7          	jalr	-538(ra) # 0 <noise>
     222:	87aa                	mv	a5,a0
     224:	86be                	mv	a3,a5
     226:	f7043703          	ld	a4,-144(s0)
     22a:	f8c42783          	lw	a5,-116(s0)
     22e:	97ba                	add	a5,a5,a4
     230:	00d78023          	sb	a3,0(a5)
    for (int j = 0; j < blks; j++)
     234:	f8c42783          	lw	a5,-116(s0)
     238:	2785                	addiw	a5,a5,1
     23a:	f8f42623          	sw	a5,-116(s0)
     23e:	f8c42703          	lw	a4,-116(s0)
     242:	f6042783          	lw	a5,-160(s0)
     246:	fcf764e3          	bltu	a4,a5,20e <main+0x182>
    if (write_raid(i, data) < 0)
     24a:	f9042783          	lw	a5,-112(s0)
     24e:	f7043583          	ld	a1,-144(s0)
     252:	853e                	mv	a0,a5
     254:	00000097          	auipc	ra,0x0
     258:	6aa080e7          	jalr	1706(ra) # 8fe <write_raid>
     25c:	87aa                	mv	a5,a0
     25e:	0007df63          	bgez	a5,27c <main+0x1f0>
    {
      printf("Fatal error in write_raid\n");
     262:	00001517          	auipc	a0,0x1
     266:	eee50513          	addi	a0,a0,-274 # 1150 <malloc+0x1b0>
     26a:	00001097          	auipc	ra,0x1
     26e:	b44080e7          	jalr	-1212(ra) # dae <printf>
      exit(-2);
     272:	5579                	li	a0,-2
     274:	00000097          	auipc	ra,0x0
     278:	5da080e7          	jalr	1498(ra) # 84e <exit>
  for (int i = l; i < u; i++)
     27c:	f9042783          	lw	a5,-112(s0)
     280:	2785                	addiw	a5,a5,1
     282:	f8f42823          	sw	a5,-112(s0)
     286:	f9042783          	lw	a5,-112(s0)
     28a:	873e                	mv	a4,a5
     28c:	f9842783          	lw	a5,-104(s0)
     290:	2701                	sext.w	a4,a4
     292:	2781                	sext.w	a5,a5
     294:	f6f74ae3          	blt	a4,a5,208 <main+0x17c>
    }
  }
  ...
  disk_repaired_raid(2);
     ...
     29e:	674080e7          	jalr	1652(ra) # 90e <disk_repaired_raid>

  for (int i = l; i < u; i++)
     2a2:	f9c42783          	lw	a5,-100(s0)
     2a6:	f8f42423          	sw	a5,-120(s0)
     2aa:	a0f1                	j	376 <main+0x2ea>
  {
    for (int j = 0; j < blks; j++)
     2ac:	f8042223          	sw	zero,-124(s0)
     2b0:	a839                	j	2ce <main+0x242>
      data[j] = 'c';
     2b2:	f7043703          	ld	a4,-144(s0)
     2b6:	f8442783          	lw	a5,-124(s0)
     2ba:	97ba                	add	a5,a5,a4
     2bc:	06300713          	li	a4,99
     2c0:	00e78023          	sb	a4,0(a5)
    for (int j = 0; j < blks; j++)
     2c4:	f8442783          	lw	a5,-124(s0)
     2c8:	2785                	addiw	a5,a5,1
     2ca:	f8f42223          	sw	a5,-124(s0)
     2ce:	f8442703          	lw	a4,-124(s0)
     2d2:	f6042783          	lw	a5,-160(s0)
     2d6:	fcf76ee3          	bltu	a4,a5,2b2 <main+0x226>

    if (read_raid(i, data) < 0)
     2da:	f8842783          	lw	a5,-120(s0)
     2de:	f7043583          	ld	a1,-144(s0)
     2e2:	853e                	mv	a0,a5
     2e4:	00000097          	auipc	ra,0x0
     2e8:	612080e7          	jalr	1554(ra) # 8f6 <read_raid>
     2ec:	87aa                	mv	a5,a0
     2ee:	0007df63          	bgez	a5,30c <main+0x280>
    {
      printf("Fatal error in read_raid\n");
     2f2:	00001517          	auipc	a0,0x1
     2f6:	e7e50513          	addi	a0,a0,-386 # 1170 <malloc+0x1d0>
     2fa:	00001097          	auipc	ra,0x1
     2fe:	ab4080e7          	jalr	-1356(ra) # dae <printf>
      exit(-3);
     302:	5575                	li	a0,-3
     304:	00000097          	auipc	ra,0x0
     308:	54a080e7          	jalr	1354(ra) # 84e <exit>
    }

    for (int j = 0; j < blks; j++)
     30c:	f8042023          	sw	zero,-128(s0)
     310:	a881                	j	360 <main+0x2d4>
      if (data[j] != noise(i, j))
     312:	f7043703          	ld	a4,-144(s0)
     316:	f8042783          	lw	a5,-128(s0)
     31a:	97ba                	add	a5,a5,a4
     31c:	0007c483          	lbu	s1,0(a5)
     320:	f8042703          	lw	a4,-128(s0)
     324:	f8842783          	lw	a5,-120(s0)
     328:	85ba                	mv	a1,a4
     32a:	853e                	mv	a0,a5
     32c:	00000097          	auipc	ra,0x0
     330:	cd4080e7          	jalr	-812(ra) # 0 <noise>
     334:	87aa                	mv	a5,a0
     336:	8726                	mv	a4,s1
     338:	00f70f63          	beq	a4,a5,356 <main+0x2ca>
      {
        printf("Bad read\n");
     33c:	00001517          	auipc	a0,0x1
     340:	e5450513          	addi	a0,a0,-428 # 1190 <malloc+0x1f0>
     344:	00001097          	auipc	ra,0x1
     348:	a6a080e7          	jalr	-1430(ra) # dae <printf>
        exit(-4);
     34c:	5571                	li	a0,-4
     34e:	00000097          	auipc	ra,0x0
     352:	500080e7          	jalr	1280(ra) # 84e <exit>
    for (int j = 0; j < blks; j++)
     356:	f8042783          	lw	a5,-128(s0)
     35a:	2785                	addiw	a5,a5,1
     35c:	f8f42023          	sw	a5,-128(s0)
     360:	f8042703          	lw	a4,-128(s0)
     364:	f6042783          	lw	a5,-160(s0)
     368:	faf765e3          	bltu	a4,a5,312 <main+0x286>
  for (int i = l; i < u; i++)
     36c:	f8842783          	lw	a5,-120(s0)
     370:	2785                	addiw	a5,a5,1
     372:	f8f42423          	sw	a5,-120(s0)
     376:	f8842783          	lw	a5,-120(s0)
     37a:	873e                	mv	a4,a5
     37c:	f9842783          	lw	a5,-104(s0)
     380:	2701                	sext.w	a4,a4
     382:	2781                	sext.w	a5,a5
     384:	f2f744e3          	blt	a4,a5,2ac <main+0x220>
      }
  }

  printf("Good read\n");
     388:	00001517          	auipc	a0,0x1
     38c:	e1850513          	addi	a0,a0,-488 # 11a0 <malloc+0x200>
     390:	00001097          	auipc	ra,0x1
     394:	a1e080e7          	jalr	-1506(ra) # dae <printf>
  exit(0);
     398:	4501                	li	a0,0
...
_main()
{
  ...
  main();
     ...
     3ae:	ce2080e7          	jalr	-798(ra) # 8c <main>
  exit(0);
     3b2:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     9d6:	9ce68693          	addi	a3,a3,-1586 # 23a0 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     aaa:	8fa70713          	addi	a4,a4,-1798 # 23a0 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     c6a:	54a78793          	addi	a5,a5,1354 # 11b0 <malloc+0x210>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     e16:	5be78793          	addi	a5,a5,1470 # 23d0 <freep>
     e1a:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     f0e:	4c678793          	addi	a5,a5,1222 # 23d0 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     f90:	44478793          	addi	a5,a5,1092 # 23d0 <freep>
     f94:	639c                	ld	a5,0(a5)
}
     f96:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     fc2:	41278793          	addi	a5,a5,1042 # 23d0 <freep>
     fc6:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     fd6:	3ee78793          	addi	a5,a5,1006 # 23c0 <base>
     fda:	fef43023          	sd	a5,-32(s0)
     fde:	00001797          	auipc	a5,0x1
     fe2:	3f278793          	addi	a5,a5,1010 # 23d0 <freep>
     fe6:	fe043703          	ld	a4,-32(s0)
     fea:	e398                	sd	a4,0(a5)
     fec:	00001797          	auipc	a5,0x1
     ff0:	3e478793          	addi	a5,a5,996 # 23d0 <freep>
     ff4:	6398                	ld	a4,0(a5)
     ff6:	00001797          	auipc	a5,0x1
     ffa:	3ca78793          	addi	a5,a5,970 # 23c0 <base>
     ffe:	e398                	sd	a4,0(a5)
    base.s.size = 0;
    1000:	00001797          	auipc	a5,0x1
    1004:	3c078793          	addi	a5,a5,960 # 23c0 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    107e:	35678793          	addi	a5,a5,854 # 23d0 <freep>
    ...
    1094:	34078793          	addi	a5,a5,832 # 23d0 <freep>
